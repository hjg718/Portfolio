					...
					<div id="inputCon">
						<form:form action="join" commandName="userVo" method="post"
							...
							<div class="form-group" id="iddiv">
								...
								<div class="col-sm-10">
									<form:input path="userid" class="form-control" id="id"
										placeholder="영문, 숫자로 구성 된 5~16 문자를 입력해주세요." />
									<div class="help-block">
										<button type="button" class="btn btn-theme"
											onclick="idCheck();">중복검사</button>
										<c:if test="${overlap }">
											<span class="red">중복된아이디입니다.</span>
										</c:if>
										<br> <span id="idLength"></span>
										<form:errors path="userid" cssClass="red" />
									</div>
								</div>
							</div>
							...
							<div class="form-group" id="pwddiv">
								...
								<div class="col-sm-10">
									<form:password path="upwd" class="form-control" id="pwd"
										placeholder="영문, 숫자으로 구성 된  6~18 문자를 입력해주세요." />
									<span class="help-block"> <span id="pwdLength"></span> <form:errors
											path="upwd" cssClass="red" />
									</span>
								</div>
							</div>
