		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<P></P>
					<div id="inputCon">
						<form:form action="edit" commandName="userVo" method="post"
							class="form-horizontal" id="editForm" onsubmit="return re();">
							...
							<div class="form-group" id="newPwdDiv">
								...
								<div class="col-sm-10" id="newBut">
									<button type="button" onclick="tog();"
										class="btn btn-theme btn-sm">비밀번호 변경</button>
								</div>
								<div class="col-sm-10" id="newPwdCon">
									<input type="password" name="newpwd" class="form-control"
										id="newPwd"
										placeholder="새로운 비밀번호를 영문, 숫자으로 구성 된  6~18 문자로 입력해주세요." /> <span
										class="help-block"> <span id="newPwdLength"></span><br>
										<button type="reset" onclick="tog();"
											class="btn btn-theme btn-sm">취소</button>
									</span>
								</div>
							</div>
							...
							<div class="form-group" id="phoneDiv">
								...
								<div class="col-sm-10">
									...
									<span class="help-block"> "-"없이 입력해주세요.<br>
									</span>
								</div>
							</div>
							...
							<div class="form-group" id="genderDiv">
								...
								<div class="col-sm-10">
									...
									<label class="radio-inline"> <form:radiobutton
											path="gender" id="male" value="m" /> 남성
									</label> <label class="radio-inline"> <form:radiobutton
											path="gender" id="female" value="f" /> 여성
									</label>
								</div>
							</div>
							<div id="bset">
								<a href="#editModal" data-toggle="modal"><button
										type="button" class="btn btn-theme">작성완료</button></a>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">정보 수정을 원하시면 현재 비밀번호를 입력해주세요. (필수사항)</div>
