		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<P></P>
					<div id="inputCon">
						<form id="proposalF" class="form-horizontal" action="save"
							method="post" onsubmit="return save();">
							<input type="hidden" name="${_csrf.parameterName }"
							...
							<div class="form-group" id="contentsDiv">
								...
								<div class="col-sm-10">
									<textarea class="form-control" rows="15" style="resize: none;"
										name="qcontents" id="qcontents" placeholder="문의 하실 내용을 입력해주세요"></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" disabled class="form-control"
										value="<sec:authorize access="!isAuthenticated()">익명</sec:authorize>
<sec:authorize access="isAuthenticated()">${id }</sec:authorize>">
									<input type="hidden" name="author"
										value="<sec:authorize access="!isAuthenticated()">익명</sec:authorize>
<sec:authorize access="isAuthenticated()">${id }</sec:authorize>">
									<div class="help-block">로그인을 안하신 경우 익명으로 작성됩니다.</div>
								</div>
							</div>
							...
							<div class="form-group" id="pwdDiv">
								...
								<div class="col-sm-10">
									...
									<div class="help-block">
										숫자로 된 4자리 비밀번호를 설정 해 주세요.<br> 이후 글 수정,삭제를 위해서 필요합니다.
									</div>
								</div>
							</div>
