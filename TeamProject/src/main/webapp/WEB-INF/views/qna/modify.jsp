		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<P></P>
					<div id="inputCon">
						<form:form class="form-horizontal" modelAttribute="read"
							action="modify" method="post" onsubmit="return modify();">
							...
							<div class="form-group" id="contentsDiv">
								...
								<div class="col-sm-10">
									<form:textarea path="qcontents" class="form-control" rows="15"
										style="resize: none;" id="qcontents"></form:textarea>
								</div>
							</div>
