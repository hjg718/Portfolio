		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<P></P>
					<div id="inputCon">
						<form id="inputForm" class="form-horizontal" action="input"
							method="post" onsubmit="return boardInput();">
							<input type="hidden" name="${_csrf.parameterName }"
							...
							<div class="form-group" id="contentsDiv">
								...
								<div class="col-sm-10">
									<textarea class="form-control" rows="15" style="resize: none;"
										name="contents" id="contents" placeholder="문의 하실 내용을 입력해주세요"></textarea>
								</div>
							</div>
