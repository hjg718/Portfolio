				...
				<div class="col-md-8 col-md-offset-2">
					...
					<div id="inputCon">
						<form:form class="form-horizontal" id="editForm"
							modelAttribute="list" method="post" onsubmit="return update();">
							...
							<div class="form-group" id="contentsDiv">
								...
								<div class="col-sm-10">
									<form:textarea path="contents" class="form-control" rows="15"
										style="resize: none;" id="contents"></form:textarea>
								</div>
							</div>
