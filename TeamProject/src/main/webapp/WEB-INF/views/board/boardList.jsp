			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<div class="panel panel-success">
						<div class="panel-heading">베스트 글</div>
							...
							<table class="table table-striped table-hover">
								...
								<c:forEach var="b" items="${goodlist}">
									<tr>
										<td>${b.num}</td>
										<td id="title"><a
											href="<c:url value="/board/info?num=${b.num}&readCnt=${b.readCnt}"/>">${b.title}</a></td>
										<td>${b.author}</td>
										<td>${b.readCnt}</td>
										<td>${b.goodcnt}</td>
									</tr>
					...
					<div class="panel panel-success">
						...
						<div class="panel-body">
							...
							<div id="toolBox">
								...
								<form id="searchF" onsubmit="return searched();"
									class="navbar-form">
									<input type="hidden" name="${_csrf.parameterName }"
										value="${_csrf.token }"> <input type="hidden"
										name="page" value="1"> <select name="category"
										class="form-control">
