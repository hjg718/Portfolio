			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<div id="inputCon">
						...
						<form:form commandName="book.vo"
							action="edit?${_csrf.parameterName }=${_csrf.token }"
							enctype="multipart/form-data" method="post"
							class="form-horizontal" onsubmit="return re();">
							<form:hidden path="bnum" />
							<div class="form-group" id="coverdiv">
								<label for="cover" class="col-sm-2 control-label">표지</label>
								<div class="col-sm-10">
									<img
										src="<c:url value="/book/img?coverName=${book.vo.coverName}"/>"
										width="29%" height="170px" id="coverimg" class="img-rounded">
									<form:input path="cover" type="file" class="form-control"
										id="cover" />
								</div>
							</div>
							...
							<div class="form-group" id="bnamediv">
								...
								<div class="col-sm-10">
									<form:input path="bname" class="form-control" id="bname"
							...
							<div class="form-group" id="bindexdiv">
								...
								<div class="col-sm-10">
									<form:textarea path="bindex" class="form-control" rows="5"
										style="resize: none;" id="bindex" placeholder="목차를 입력해주세요" />
								</div>
							</div>
							...
							<div class="form-group" id="publisherdiv">
								...
								<div class="col-sm-10">
									<form:input path="publisher" class="form-control"
										id="publisher" placeholder="출판사를 입력해주세요" />
								</div>
							</div>
							...
							<div class="form-group" id="bcontentsdiv">
								...
								<div class="col-sm-10">
									<form:textarea path="bcontents" class="form-control" rows="5"
										style="resize: none;" id="bcontents"
							...
							<div class="form-group" id="pdatediv">
								...
								<div class="col-sm-10">
									<form:input path="pdate" type="date" class="form-control"
										id="pdate" />
								</div>
							</div>
							...
							<div class="form-group" id="catediv">
								...
								<div class="col-sm-10" id="cate">
									...
									<label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="소설" label="소설" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="에세이" label="에세이" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="시" label="시" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="수필" label="수필" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="자서전" label="자서전" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="여행" label="여행" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="사회/이슈" label="사회/이슈" />
									</label> <br> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="과학" label="과학" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="위인/전기" label="위인/전기" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="기술서" label="기술서" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="만화" label="만화" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="요리" label="요리" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="음악" label="음악" />
									</label> <label class="checkbox-inline"> <form:checkbox
											path="cate" class="cate" value="학습서" label="학습서" />
									</label>
	...
	<div class="modal fade" id="bookForm" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body" id="bookFormBody"></div>
