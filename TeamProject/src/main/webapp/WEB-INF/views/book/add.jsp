					...
					<div id="inputCon">
						<form action="addbook?${_csrf.parameterName }=${_csrf.token }"
							...
							<div class="form-group" id="coverdiv">
								...
								<div class="col-sm-10">
									<img src="" width="29%" height="170px" id="coverimg"
										class="img-rounded"> <input type="file"
										class="form-control" id="cover" name="cover">
								</div>
							</div>
							...
							<div class="form-group" id="authordiv">
								...
								<div class="col-sm-10">
									<input type="text" name="author" class="form-control"
										id="author" placeholder="저자를 입력해주세요">
								</div>
							</div>
							...
							<div class="form-group" id="bindexdiv">
								...
								<div class="col-sm-10">
									<textarea class="form-control" rows="5" style="resize: none;"
										name="bindex" id="bindex" placeholder="목차를 입력해주세요"></textarea>
								</div>
							</div>
							...
							<div class="form-group" id="bcontentsdiv">
								...
								<div class="col-sm-10">
									<textarea class="form-control" rows="5" style="resize: none;"
										name="bcontents" id="bcontents" placeholder="상세내용을 입력해주세요"></textarea>
								</div>
							</div>
							...
							<div class="form-group" id="catediv">
								...
								<div class="col-sm-10" id="cate">
									...
									<label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="소설"> 소설
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="에세이">에세이
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="시">시
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="수필">수필
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="자서전">자서전
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="여행">여행
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="사회/이슈">사회/이슈
									</label> <br> <label class="checkbox-inline"> <input
										type="checkbox" name="cate" value="과학">과학
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="위인/전기">위인/전기
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="기술서">기술서
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="만화">만화
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="요리">요리
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="음악">음악
									</label> <label class="checkbox-inline"> <input type="checkbox"
										name="cate" value="학습서">학습서
									</label>
