...
<link href="<c:url value='/resources/assets/css/bootstrap-theme.css'/>"
	rel="stylesheet" />
<link rel="stylesheet"
	href="<c:url value='/resources/assets/css/slippry.css'/>">
...
<body>
	...
	<section id="intro">
		<div id="search">
			<div id="searchForm">
				<form action="<c:url value="/book/search"/>" method="post"
					...
					</select> <input type="text" name="keyword" class="form-control input-lg">
					<br>
		...
		<ul id="slippry-slider">
			<li><a><img
					src="<c:url value='/resources/assets/img/slide/1.jpg'/>"
					alt="환영합니다."></a></li>
			<li><a><img
					src="<c:url value='/resources/assets/img/slide/2.jpg'/>"
					alt="원하시는 도서를 검색하세요"></a></li>
			<li><a><img
					src="<c:url value='/resources/assets/img/slide/3.jpg'/>"
					alt="감사합니다. <span class='red'>♥</span>:)"></a></li>
		</ul>
	</section>
	<section id="about">
					...
					<div class="team-box">
						<div class="roles">
							...
							<ul class="social-profile">
								<li><a href="https://github.com/hjg718/Portfolio"><i
