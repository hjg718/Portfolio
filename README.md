...
<p style="margin-top: 0px;margin: 1em 0px; word-wrap: break-word;">   <strong>1. 총괄 코딩 </strong> : 도서 기능, 유저 기능 코딩 및 기타 기능 <br style="clear: both;">   <strong>2. 디자인</strong> : 부트스트랩 템플릿을 활용한 CSS 적용 및 JavaScript 담당<br style="clear: both;">   <strong>3. DB 구축</strong> : ERMaster를 통한 DB 설계 및 SQL 담당</p>
