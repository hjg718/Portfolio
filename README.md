...
<p style="margin-top: 0px;margin: 1em 0px; word-wrap: break-word;">   <strong>1. 총괄 코딩 </strong> : 도서 기능(대여, 반납,예약, 업로드, 수정, 삭제 등등), 유저 기능(가입, 탈퇴, 수정, 대여 현황보기 ) 코딩 및 기타 기능 <br style="clear: both;">   <strong>2. 디자인</strong> : 부트스트랩 템플릿을 활용한 CSS 적용 및 JavaScript 담당<br style="clear: both;">   <strong>3. DB 구축</strong> : ERMaster를 통한 DB 설계 및 SQL 담당</p>
